    ...
    const getChatModePrompt = (mode: string, content: string) => {
        ...
        switch(mode){
            case "review":
                return `Please review this codend provide detailed suggestions for improvement including performance,security and best practices:\n\n**Request:**${content}`
            case "fix":
                return `Please help fix issues in this code, including bugs errors and potential problems:\n\n**Problem:**${content} `
            case "optimize":
                return `Please analyze this code for performance optimization and suggestimprovements:\n\n**Code to Optimize:**${content}`
            default:
                return content
        }
    };
    ...
    components={{
        code: ({ children, className, ...props }) => {   // ← ...with this
