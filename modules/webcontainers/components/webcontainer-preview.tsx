        ...
        async function setupContainer() {
            ...
            try {
                ...
                try {
                    ...
                    // package.json doesn't exist yet — fall through to full setup
                }
            ...
            {!previewUrl ? (
                <div className="h-full flex flex-col">
                    ...
                    <div className="flex-1 p-4">
                        {/* TODO: replace with your real terminal component (e.g. xterm.js wrapper) */}
                        <div ref={terminalRef} className="h-full bg-black text-green-400 font-mono text-xs p-2 rounded">
                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="h-64 border-t">
                        {/* TODO: replace with your real terminal component */}
                        <div ref={terminalRef} className="h-full bg-black text-green-400 font-mono text-xs p-2 rounded">
                            Terminal output placeholder
                        </div>
                    </div>
